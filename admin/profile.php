...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/pages/user-profile-page.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns">
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-light">
          <div class="nav-wrapper">
            ...
            <ul class="navbar-list right">
              <li class="dropdown-language"><a class="waves-effect waves-block waves-light translation-button" href="user-profile-page.html#" data-target="translation-dropdown"><span class="flag-icon flag-icon-gb"></span></a></li>
              ...
              <li><a class="waves-effect waves-block waves-light sidenav-trigger" href="user-profile-page.html#" data-target="slide-out-right"><i class="material-icons">format_indent_increase</i></a></li>
            </ul>
            <!-- translation-button-->
            <ul class="dropdown-content" id="translation-dropdown">
              <li class="dropdown-item"><a class="grey-text text-darken-1" href="user-profile-page.html#!" data-language="en"><i class="flag-icon flag-icon-gb"></i> English</a></li>
              <li class="dropdown-item"><a class="grey-text text-darken-1" href="user-profile-page.html#!" data-language="fr"><i class="flag-icon flag-icon-fr"></i> French</a></li>
              <li class="dropdown-item"><a class="grey-text text-darken-1" href="user-profile-page.html#!" data-language="pt"><i class="flag-icon flag-icon-pt"></i> Portuguese</a></li>
              <li class="dropdown-item"><a class="grey-text text-darken-1" href="user-profile-page.html#!" data-language="de"><i class="flag-icon flag-icon-de"></i> German</a></li>
            </ul>
            ...
            <ul class="dropdown-content" id="notifications-dropdown">
              ...
              <li class="divider"></li>
              <li><a class="black-text" href="user-profile-page.html#!"><span class="material-icons icon-bg-circle cyan small">add_shopping_cart</span> A new order has been placed!</a>
                <time class="media-meta grey-text darken-2" datetime="2015-06-12T20:50:48+08:00">2 hours ago</time>
              </li>
              <li><a class="black-text" href="user-profile-page.html#!"><span class="material-icons icon-bg-circle red small">stars</span> Completed the task</a>
                <time class="media-meta grey-text darken-2" datetime="2015-06-12T20:50:48+08:00">3 days ago</time>
              </li>
              <li><a class="black-text" href="user-profile-page.html#!"><span class="material-icons icon-bg-circle teal small">settings</span> Settings updated</a>
                <time class="media-meta grey-text darken-2" datetime="2015-06-12T20:50:48+08:00">4 days ago</time>
              </li>
              <li><a class="black-text" href="user-profile-page.html#!"><span class="material-icons icon-bg-circle deep-orange small">today</span> Director meeting started</a>
                <time class="media-meta grey-text darken-2" datetime="2015-06-12T20:50:48+08:00">6 days ago</time>
              </li>
              <li><a class="black-text" href="user-profile-page.html#!"><span class="material-icons icon-bg-circle amber small">trending_up</span> Generate monthly report</a>
    ...
    <ul class="display-none" id="default-search-main">
      <li class="auto-suggestion-title"><a class="collection-item" href="user-profile-page.html#">
          <h6 class="search-title">FILES</h6></a></li>
      <li class="auto-suggestion"><a class="collection-item" href="user-profile-page.html#">
    ...
    <ul class="display-none" id="search-not-found">
      <li class="auto-suggestion"><a class="collection-item display-flex align-items-center" href="user-profile-page.html#"><span class="material-icons">error_outline</span><span class="member-info">No results found.</span></a></li>
    </ul>
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down " src="../../../app-assets/images/logo/materialize-logo.png" alt="materialize logo"/><img class="show-on-medium-and-down hide-on-med-and-up" src="../../../app-assets/images/logo/materialize-logo-color.png" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Materialize</span></a><a class="navbar-toggler" href="user-profile-page.html#"><i class="material-icons">radio_button_checked</i></a></h1>
      </div>
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
              ...
              <li><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Vertical">Vertical</span></a>
                <div class="collapsible-body">
                  <ul class="collapsible" data-collapsible="accordion">
                    ...
                    <li><a href="index.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Dark Menu">Dark Menu</span></a>
                    </li>
                  </ul>
                </div>
              </li>
        ...
        <li class="active bold"><a class="waves-effect waves-cyan active " href="user-profile-page.html"><i class="material-icons">person_outline</i><span class="menu-title" data-i18n="User Profile">User Profile</span></a>
        </li>
      ...
      <div class="navigation-background"></div><a class="sidenav-trigger btn-sidenav-toggle btn-floating btn-medium waves-effect waves-light hide-on-large-only" href="user-profile-page.html#" data-target="slide-out"><i class="material-icons">menu</i></a>
    </aside>
    <!-- END: SideNav-->
            ...
            <div class="row">
              ...
              <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="user-profile-page.html#">Pages</a>
                  </li>
    ...
    <div class="row">
      ...
      <div class="col s12 m4 l3 user-section-negative-margin">
        ...
        <div class="row mt-5">
          <div class="col s6">
            <h6>Follower</h6>
            <h5 class="m-0"><a href="user-profile-page.html#">540</a></h5>
          </div>
          <div class="col s6">
            <h6>Following</h6>
            <h5 class="m-0"><a href="user-profile-page.html#">128</a></h5>
          </div>
        </div>
        <hr>
        <div class="row">
          <div class="col s12">
            ...
            <p class="m-0"><a href="user-profile-page.html#">56</a> and <a href="user-profile-page.html#">42</a> reviews</p>
          </div>
        </div>
        <hr>
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/1.jpg" alt=""></a>
          </div>
          <div class="col s9">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/11.jpg" alt=""></a>
          </div>
          <div class="col s9">
            <a href="user-profile-page.html#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/5.jpg" alt=""></a>
          </div>
          <div class="col s9">
            <a href="user-profile-page.html#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle pb-2">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/8.jpg" alt=""></a>
          </div>
          <div class="col s9">
            <a href="user-profile-page.html#">
            ...
            <div class="card-content card-border-gray">
              ...
              <div class="row">
                <div class="col s12">
                  <ul class="tabs card-border-gray mt-4">
                    <li class="tab col m3 s6 p-0"><a href="user-profile-page.html#test1">
                        <i class="material-icons vertical-align-middle">crop_portrait</i> Info
                      </a></li>
                    <li class="tab col m3 s6 p-0"><a class="active" href="user-profile-page.html#test2">
                        <i class="material-icons vertical-align-middle">bookmark_border</i> Feed
                      </a></li>
                    <li class="tab col m3 s6 p-0"><a href="user-profile-page.html#test3">
                        <i class="material-icons vertical-align-middle">date_range</i> Agenda
                      </a></li>
                    <li class="tab col m3 s6 p-0"><a href="user-profile-page.html#test4">
              ...
              <div class="row mt-5">
                <div class="col s1 pr-0 circle">
                  <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/12.jpg"
                      alt=""></a>
                </div>
                <div class="col s11">
                  <a href="user-profile-page.html#">
                    ...
                    <div class="col s12">
                      <div class="card card-border z-depth-2">
                        ...
                        <div class="card-content">
                          <h6 class="font-weight-900 text-uppercase"><a href="user-profile-page.html#">Designing Services</a></h6>
                  ...
                  <div class="row">
                    <div class="col s12">
                      <div class="card card-border z-depth-2">
                        ...
                        <div class="card-content">
                          <h6 class="font-weight-900 text-uppercase"><a href="user-profile-page.html#">Australia office hours</a></h6>
                          <p>Working so hard</p>
                        </div>
                      </div>
                      <div class="social-icon">
              ...
              <div class="row mt-5">
                <div class="col s1 pr-0 circle">
                  <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/7.jpg" alt=""></a>
                </div>
                <div class="col s11">
                  <a href="user-profile-page.html#">
                        ...
                        <div class="card-content">
                          <div class="row">
                            <div class="col s2 pr-0 circle">
                              <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/1.jpg"
                                  alt=""></a>
                            </div>
                            <div class="col s10">
                              <a href="user-profile-page.html#">
                          ...
                          <hr>
                          <h6 class="font-weight-900 text-uppercase"><a href="user-profile-page.html#">Senior Developer</a></h6>
      ...
      <div class="col s12 m12 l3 hide-on-med-and-down">
        <div class="row mt-5">
          <div class="col s12">
            ...
            <img class="responsive-img card-border z-depth-2 mt-2" src="../../../app-assets/images/gallery/post-3.png"
              alt="">
            <p><a href="user-profile-page.html#">Meeting with clients</a></p>
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/2.jpg" alt=""></a>
          </div>
          <div class="col s9">
            <a href="user-profile-page.html#">
        ...
        <div class="row mt-2">
          <div class="col s2 mt-2 pr-0 circle">
            <a href="user-profile-page.html#"><img class="responsive-img circle" src="../../../app-assets/images/user/4.jpg" alt=""></a>
          </div>
          <div class="col s9">
            <a href="user-profile-page.html#">
        ...
        <div class="row">
          <div class="col s12">
            ...
            <p class="latest-update">Make Metronic<span class="right"> <a href="user-profile-page.html#">+480</a> </span></p>
            <p class="latest-update">Programming Language <span class="right"> <a href="user-profile-page.html#">+12</a> </span></p>
            <p class="latest-update">Project completed <span class="right"> <a href="user-profile-page.html#">+570</a> </span></p>
            <p class="latest-update">New Customer <span class="right"><a href="user-profile-page.html#">+120</a> </span></p>
            <p class="latest-update">Annual Companies<span class="right"> <a href="user-profile-page.html#">+890</a> </span></p>
          </div>
        </div>
      </div>
    </div>
...
<aside id="right-sidebar-nav">
        ...
        <div class="col s12 border-bottom-1 pb-0 pt-1">
          <div class="row">
            <div class="col s2 pr-0 center">
              <i class="material-icons vertical-text-middle"><a href="user-profile-page.html#" class="sidenav-close">clear</a></i>
            </div>
            <div class="col s10 pl-0">
              <ul class="tabs">
                <li class="tab col s4 p-0">
                  <a href="user-profile-page.html#messages" class="active">
                    <span>Messages</span>
                  </a>
                </li>
                <li class="tab col s4 p-0">
                  <a href="user-profile-page.html#settings">
                    <span>Settings</span>
                  </a>
                </li>
                <li class="tab col s4 p-0">
                  <a href="user-profile-page.html#activity">
                    <span>Activity</span>
                  </a>
                </li>
              </ul>
  ...
  <ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat">
    <li class="center-align pt-2 pb-2 sidenav-close chat-head">
      <a href="user-profile-page.html#!"><i class="material-icons mr-0">chevron_left</i>Elizabeth Elliott</a>
    </li>
    <li class="chat-body">
      <ul class="collection">
...
<div id="theme-cutomizer-out" class="theme-cutomizer sidenav row">
   <div class="col s12">
      <a class="sidenav-close" href="user-profile-page.html#!"><i class="material-icons">close</i></a>
...
>
    ...
    <footer class="page-footer footer footer-static footer-light navbar-border navbar-shadow">
      <div class="footer-copyright">
        <div class="container"><span>&copy; 2020          <a href="http://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank">PIXINVENT</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="../../../app-assets/vendors/quill/fonts/KaTeX_Typewriter-Regular.woff2.html">PIXINVENT</a></span></div>
      </div>
    </footer>
